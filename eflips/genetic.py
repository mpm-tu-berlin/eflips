...
class BinaryGeneticIteratorAbstract(metaclass=ABCMeta):
    def __init__(self, population_size, num_bits, best_selection_share,
                 mutation_rate, fitness_tolerance=1e-5):
    ...
    def export_current_state_dict(self):
    ...
    def import_current_state_dict(self, import_data):
        ...
        self._best_selection_share = import_data['best_selection_share']
        self._mutation_rate = import_data['mutation_rate']
        self._fitness_tolerance = import_data['fitness_tolerance']
        self._current_population = import_data['current_population']
        self._current_generation = import_data['current_generation']
        self._total_time = import_data['total_time']
        self._fitness_function_calls_total = import_data['fitness_function_calls_total']
        self._fitness_function_calls_unique = import_data['fitness_function_calls_unique']
        self.peak_fitness = import_data['peak_fitness']
        self.peak_fitness_chromosomes = import_data['peak_fitness_chromosomes']
        self.peak_fitness_chromosomes_decoded = import_data['peak_fitness_chromosomes_decoded']
        self.history = import_data['history']
        self._fitness_cache = import_data['fitness_cache']
    ...
    def save(self, output_path, base_name='binary_genetic',
        ...
        export_data = self.export_current_state_dict()
    ...
    def iterate(self, mutate_offspring_only=True, multicore=False,
        ...
        while True:
            ...
            if len(population_offspring) > num_new:
                shorten_by = num_new - len(population_offspring)
...
class ChargingInfrastructureIterator(BinaryGeneticIteratorAbstract):
    def __init__(self, timetable, grid, scheduling_params, charging_stations,
        ...
        super().__init__(population_size, num_bits, best_selection_share,
                 mutation_rate, fitness_tolerance=fitness_tolerance)

    def save(self, output_path, base_name='charging_infrastructure_iterator',
             replace_file=True):
        export_data = {
            'iterator_state': self.export_current_state_dict(),
    ...
    def _calculate_fitness_eflips(self, chromosome):
        ...
        schedules, grid = generate_schedules_singledepot(
