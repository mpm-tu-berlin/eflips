# -*- coding: utf-8 -*-
"""Demo script for bus schedule simulation with depot charging (DC) using a
manually created simulation environment.
...
output_path = os.path.join(output_path_base, 'Custom_Simulation_DC')
simdata_file = "simdata_DC.pickle"
...
charging_network.create_point(eflips.energy.ChargingInterfaceTypes.plug,
                              depot_grid_point,
